...
{
    public abstract class EduardoproyectWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static EduardoproyectWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(EduardoproyectWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<EduardoproyectDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<EduardoproyectDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<EduardoproyectDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<EduardoproyectDbContext, Task<T>> func)
        {
            T result;
